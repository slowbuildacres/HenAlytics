...
// ---- LEGACY: kept for backwards compat reference but no longer rendered ----
// (old FlockHistoryList and EggBasket replaced by FlockBasket above)

 (one per Add Birds event), with tap-to-edit
